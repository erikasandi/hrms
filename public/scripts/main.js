...
var sublimeApp = function () {
  ...
  function initMenuCollapse() {
    // console.log('init menu collapse');
    $(document).on('click', '.main-navigation a', function (e) {
      // console.log('click .main-navigation a');
    ...
    //  console.log('.main-navigation > .nav > li.open');
    //  $('.sub-menu').hide();
    //  $(this).children('.sub-menu').show();
    //});

    $('.main-navigation > .nav').find('li.open').each(function () {
      // console.log(this);
      $(this).children('.sub-menu').show();
    });
