...
class CreateAssetMechanicalDetails extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('asset_mechanical_details', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('asset_mechanical_details');
    }
}
