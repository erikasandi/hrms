                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase"> Work Schedule List</span>
                            </div>
                            <div class="actions">
                                <a class="btn btn-xs sbold green" href="{!! url('workschedule/add') !!}">
    ...
    <script>
        $(function() {
            $('#sample_1').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('workschedule.data') !!}',
                columns: [
                    { data: 'title', name: 'name' },
                    { data: 'started_at', name: 'start' },
                    { data: 'ended_at', name: 'end' },
