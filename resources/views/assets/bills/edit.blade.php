                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase"> Edit Bill</span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                            <form role="form" method="post" action="{!! url('bill/' . $group . '/' . $assetId . '/' . $bill->id . '/update') !!}" enctype="multipart/form-data" >
                                {{ csrf_field() }}
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="date" value="{!! $billDate !!}" class="form-control date-picker">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Tariff Code</label>
                                                    <input type="text" name="tariff_code" value="{!! $bill->tariff_code !!}" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="water_usage" value="{!! $bill->water_usage !!}" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Bill Amount</label>
                                                    <input type="text" name="bill_amount" value="{!! $bill->bill_amount !!}" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
