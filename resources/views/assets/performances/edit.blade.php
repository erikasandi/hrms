                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> Edit Asset Performance</span>
                        </div>
                        <div class="actions">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" class="form-control" placeholder="Description">{!! $performance->description !!}</textarea>
                                        </div>
                                        <div class="form-group">
