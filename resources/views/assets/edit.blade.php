                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase"> Edit Asset</span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                            <form role="form" id="form_sample_1" method="post" action="{!! url('/asset/' . $asset->id .'/update') !!}" enctype="multipart/form-data">
                                {{ csrf_field() }}
