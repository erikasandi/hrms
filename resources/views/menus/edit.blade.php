            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body">
                        <form role="form" action="{!! url('menu/' . $theMenu->id . '/update') !!}" method="post" >
                            {{ csrf_field() }}
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group @if ($errors->has('name')) has-error @endif">
                                            <label>Name</label>
                                            <input type="text" name="name" class="form-control" placeholder="Name" value="{!! $theMenu->name !!}" autofocus>
                                            @if ($errors->has('name'))
                                        ...
                                        <div class="form-group  @if ($errors->has('display')) has-error @endif">
                                            <label>Display</label>
                                            <input type="text" name="display" class="form-control" placeholder="Display Name" value="{!! $theMenu->display !!}">
                                        ...
                                        <div class="form-group  @if ($errors->has('link')) has-error @endif">
                                            <label>Link</label>
                                            <input type="text" name="link" class="form-control" placeholder="Link" value="{!! $theMenu->link !!}">
                                            @if ($errors->has('link'))
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group  @if ($errors->has('icon_class')) has-error @endif">
                                            <label>Icon</label>
                                            <input type="text" name="icon_class" class="form-control" placeholder="Icon" value="{!! $theMenu->icon_class !!}">
                                        ...
                                        <div class="form-group  @if ($errors->has('order')) has-error @endif">
                                            <label>Order</label>
                                            <input type="text" name="order" class="form-control" placeholder="Order" value="{!! $theMenu->order !!}">
                                            @if ($errors->has('order'))
