                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase"> Education Grade List</span>
                            </div>
                            <div class="actions">
                                <a class="btn btn-xs sbold green" href="{!! url('education/add') !!}">
                        ...
                        <div class="portlet-body">
                            ...
                            @endif
                            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="education">
                                <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Description</th>
