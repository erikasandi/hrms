                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">Edit Education Grade</span>
                        </div>
                        <div class="actions">
                    ...
                    <div class="portlet-body">
                        ...
                        @endif
                        <form role="form" method="post" action="{!! url('education/' . $education->id . '/update') !!}" >
                            {{ csrf_field() }}
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input type="text" name="name" class="form-control" value="{!! $education->name !!}" autofocus>
                                        </div>
                                        <div class="form-group">
