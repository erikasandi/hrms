                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            @if ($act == 'edit')
                                <span><i>edit</i> &nbsp;<b>Training History Form</b></span>                            
                            @else 
                                <span><i>add</i> &nbsp;<b>Training History Form</b></span>
                            @endif
                        </div>
                        <div class="actions">
                            <!--
                            <a class="btn btn-xs sbold green" href="{!! url('hr/employee/'.$employee_id.'/detail') !!}">
                                <i class="fa fa-arrow-left"></i> Back
                            </a>
                            -->
                            <a class="btn btn-xs sbold green" href="{!! url('hr/employee/3/'.$employee_id.'/detail') !!}">
                                <i class="fa fa-arrow-left"></i> Back
                            </a>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input data-parsley-required="true" type="text" class="form-control" name="place" placeholder="Enter Company Name" value="{{ $place }}" autofocus>
                                        </div>
                                        <div class="form-group">
                                            <label for="name">Subject</label>
                                            <input data-parsley-required="true" type="text" class="form-control" name="subject" placeholder="Enter Subject" value="{{ $subject }}">
                                        </div>
                                        <div class="form-group">
