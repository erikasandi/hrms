                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase"> Leave Period List</span>
                            </div>
                            <div class="actions">
                                <a class="btn btn-xs sbold green" href="{!! url('leaveperiod/add') !!}">
    ...
    <script>
        $(function() {
            $('#sample_1').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('leaveperiod.data') !!}',
                columns: [
                    { data: 'name', name: 'name' },
                    { data: 'started_date', name: 'starteddate' },
                    { data: 'ended_date', name: 'endeddate' },                    
