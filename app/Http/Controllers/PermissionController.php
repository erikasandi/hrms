...
class PermissionController extends Controller
{
    ...
    public function store(PermissionStore $request)
    {
        ...
        return redirect('permission')->with($this->getMessage('store'));
    }
    ...
    public function update(PermissionUpdate $request, $id)
    {
        ...
        return redirect('permission')->with($this->getMessage('update'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('permission')->with($this->getMessage('delete'));
    }
}
